...
## Introduction
This GitHub repository provides utility programs for the analysis of simulation data generated by Discrete Molecular Dynamics (DMD) and the Medusa software package, both available upon request for academic use or at [Molecules in Action, LLC](https://www.moleculesinaction.com/pdmd.html).
